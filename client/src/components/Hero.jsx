...
const Hero = () => {
  ...
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-800'>
        ...
        {isLoggedin ? <h1 className='flex items-center gap-2 text-3xl font-medium mb-2 '>Hey {authenticatedUser.username} <img className='w-8' src={assets.hand_wave} alt="" /> </h1> : <h1 className='flex items-center gap-2 text-3xl font-medium mb-2 '>Hey Developer <img className='w-8' src={assets.hand_wave} alt="" /> </h1>}
